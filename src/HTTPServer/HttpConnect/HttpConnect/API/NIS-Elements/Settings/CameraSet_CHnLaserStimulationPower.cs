...
{
    public class CameraSet_CHnLaserStimulationPower : NisAPIBase
    {
        ...
        protected override bool RunAPIImpl()
        {
            ...
            try
            {
                ...
                NisMacro.Net.Macro.Macros.Acquire.Camera.Properties.CameraSet_CHnLaserStimulationPowern macro
                    = new NisMacro.Net.Macro.Macros.Acquire.Camera.Properties.CameraSet_CHnLaserStimulationPowern
                ...
                //CameraSet_CHnLaserStimulationPower
