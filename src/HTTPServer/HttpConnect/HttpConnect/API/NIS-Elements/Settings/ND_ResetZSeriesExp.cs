...
namespace HttpConnect.API.NIS_Elements.Settings
{
    ...
    /// </summary>
    public class ND_ResetZSeriesExp : NisAPIBase
    {
        #region method
        protected override bool RunAPIImpl()
        {
            ...
            try
            {
                NisMacro.Net.Macro.Macros.ND.ZSeries.ND_ResetZSeriesExp macro =
                    new NisMacro.Net.Macro.Macros.ND.ZSeries.ND_ResetZSeriesExp();
