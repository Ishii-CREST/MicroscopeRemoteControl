...
{
    public class CameraGet_ImagingScannerWidth : NisAPIBase
    {
        #region method
		protected override bool RunAPIImpl()
        {
            try
            {
                NisMacro.Net.Macro.Macros.Acquire.Camera.Properties.CameraGet_ImagingScannerWidth macro
                    = new NisMacro.Net.Macro.Macros.Acquire.Camera.Properties.CameraGet_ImagingScannerWidth();


                //CameraGet_ImagingScannerWidth
